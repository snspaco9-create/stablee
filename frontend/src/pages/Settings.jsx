      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <p className="font-semibold text-gray-900 dark:text-white">{landlord?.full_name}</p>
              <p className="text-xs text-gray-400 dark:text-gray-500">{landlord?.email}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{theme === 'dark' ? 'Dark mode is on' : 'Light mode is on'}</p>
            </div>
            <button
              onClick={toggleTheme}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Reminder preferences</h3>
          <p className="text-xs text-gray-400 dark:text-gray-500 mb-4">Choose when to automatically remind tenants</p>
          {landlord?.plan === 'free' ? (
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-800 rounded-xl p-3 text-center">
              <p className="text-xs text-amber-700 dark:text-amber-400">Automatic reminders available on Starter and Pro plans</p>
              <button onClick={() => navigate('/pricing')} className="text-xs text-blue-600 dark:text-blue-400 mt-1 hover:underline">Upgrade now</button>
            </div>
          ) : (
            <>
